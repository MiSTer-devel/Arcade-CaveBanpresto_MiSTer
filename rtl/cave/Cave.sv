...
`endif
  ...
  reg  [1:0]   metmqstrSpriteBankActive;
  ...
  always @(posedge clock) begin
    ...
    if (reset | ~_memSys_io_ready | ~gameIsMetmqstr) begin
      metmqstrSpriteBankActive <= 2'h0;
      metmqstrSpriteBankDelay <= 2'h0;
    end
    else if (videoVBlankRising) begin
      metmqstrSpriteBankActive <= metmqstrSpriteBankDelay;
      metmqstrSpriteBankDelay <= _main_io_gpuMem_sprite_regs_bank;
    end
