...
module SpriteBlitter(
  ...
  input  [17:0] io_config_bits_sprite_code,
  ...
  reg  [17:0] configReg_sprite_code;
  ...
  wire [19:0] maxVisibleX =
    (&io_video_regs_size_x) ? 20'h001FF : {11'h0, 9'(io_video_regs_size_x - 9'h1)};
  ...
  wire [7:0] pixelData0  = io_pixelData_bits_0;
  wire [7:0] pixelData1  = io_pixelData_bits_1;
  wire [7:0] pixelData2  = io_pixelData_bits_2;
  wire [7:0] pixelData3  = io_pixelData_bits_3;
  wire [7:0] pixelData4  = io_pixelData_bits_4;
  wire [7:0] pixelData5  = io_pixelData_bits_5;
  wire [7:0] pixelData6  = io_pixelData_bits_6;
  wire [7:0] pixelData7  = io_pixelData_bits_7;
  wire [7:0] pixelData8  = io_pixelData_bits_8;
  wire [7:0] pixelData9  = io_pixelData_bits_9;
  wire [7:0] pixelData10 = io_pixelData_bits_10;
  wire [7:0] pixelData11 = io_pixelData_bits_11;
  wire [7:0] pixelData12 = io_pixelData_bits_12;
  wire [7:0] pixelData13 = io_pixelData_bits_13;
  wire [7:0] pixelData14 = io_pixelData_bits_14;
  wire [7:0] pixelData15 = io_pixelData_bits_15;
  ...
  always @(posedge clock) begin
    ...
    if (latchConfig) begin
      ...
      configReg_sprite_code <= io_config_bits_sprite_code;
  ...
  CaveSpritePixelShiftBuffer pixelShiftBuffer (
    ...
    .io_din_8         (pixelData8),
    .io_din_9         (pixelData9),
    .io_din_10        (pixelData10),
    .io_din_11        (pixelData11),
    .io_din_12        (pixelData12),
    .io_din_13        (pixelData13),
    .io_din_14        (pixelData14),
    .io_din_15        (pixelData15),
    .io_dout          (pisoPixel)
  );
